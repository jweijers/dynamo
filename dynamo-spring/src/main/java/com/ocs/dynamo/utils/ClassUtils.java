...
public final class ClassUtils {
    ...
    /**
     * Tries to retrieve an annotation, by first looking at the field name, and then at the getter
     * method
     * 
     * @param clazz
     *            the class
    ...
    /**
     * Instantiate a class with the given arguments; assumed is that all arguments are not null so
     * the types can be determined and a matching constructor can be found. When no constructor is
