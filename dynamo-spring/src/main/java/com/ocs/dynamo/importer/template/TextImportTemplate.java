...
public abstract class TextImportTemplate<ID, T> {
    ...
    /** Logger for {@link TextImportTemplate}. */
     ...
     */
    public TextImportTemplate(MessageService messageService, List<String[]> lines,
            List<String> errors, boolean checkForDuplicates) {
        this.lines = lines;
        this.errors = errors;
